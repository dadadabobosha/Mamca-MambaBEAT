...
from src.modules.ImprovedMamba import ImprovedMambaClassifier
...
# DATA_PATH: str = f"/work/scratch/js54mumy/icentia11k/icentia11k-single-lead-continuous-raw-electrocardiogram-dataset-1.0/seg_npy4/{length}"  # data path in Lichtenberg
N_CLASSES: int = 2
